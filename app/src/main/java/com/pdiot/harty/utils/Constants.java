...
public class Constants {
    ...
    public static final String DISCONNECT_RESPECK_ENABLED = "false";
    public static final String DISCONNECT_RESPECK_CLICKABLE = "false";
    public static final String CONNECT_RESPECK_ENABLED = "false";
    public static final String CONNECT_RESPECK_CLICKABLE = "false";
    public static final String RESPECK_STATUS = "Disconnected";
    public static final String CONNECT_RESPECK_BUTTON_TEXT = "DELINK";
    public static final String RESPECK_ID_ENABLED = "true";
    public static final String LAST_SENSOR_USED = "None";
    public static final String STEPS = "0";
    public static final String DAY_STEPS = "";
